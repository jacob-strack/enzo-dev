...
$fc -c opkda2.F $switch -ffixed-line-length-512 -fallow-argument-mismatch
echo "building opkda1.F"
$fc -c opkda1.F $switch -ffixed-line-length-512 -fallow-argument-mismatch
echo "building opkdamain.F"
$fc -c opkdmain.F $switch -ffixed-line-length-512 -fallow-argument-mismatch
echo "building krome_user_commons.F90"
$fc -c krome_user_commons.F90 $switch -ffree-line-length-512 -fallow-argument-mismatch
echo "building krome_all.F90"
$fc -c krome_all.F90 $switch -ffree-line-length-512 -fallow-argument-mismatch
